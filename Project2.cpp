...
GLuint BladeList; // Single Blade display list
float BladeAngle; //
...
Display()
{
	...
	if (View == OUTSIDE)
	{
		gluLookAt(25., 10., 10., 0., 0., 0., 0., 1., 0.);
		// rotate the scene:
...
InitMenus()
{
	...
	glutAddSubMenu("View", viewmenu); // Adding outside inside view to menu
